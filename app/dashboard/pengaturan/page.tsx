      ...
      <SidebarInset className="bg-muted/30">
        ...
        <main className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-6 md:px-6 lg:px-8">
          <section className="space-y-1">
            <h1 className="text-2xl font-semibold tracking-tight md:text-3xl">Pengaturan ExamBro</h1>
          ...
          <Card>
            ...
            <CardContent className="pt-6">
              <form action={updateExamBrowserSettings} className="space-y-5">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:justify-end">
                  <Button variant="outline" className="gap-2" render={<Link href="/cek-browser" />}>Cek User-Agent</Button>
